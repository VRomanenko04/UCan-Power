    ...
    return (
        <nav className={styles.navbar}>
            ...
            <ul className={styles.list}>
                <li><Link className={pathname === '/' ? styles.link : styles.black__link} href='/'>ПРО НАС</Link></li>
                <li><Link className={pathname === '/' ? styles.link : styles.black__link} href='/'>МОДЕЛЬНИЙ РЯД</Link></li>
