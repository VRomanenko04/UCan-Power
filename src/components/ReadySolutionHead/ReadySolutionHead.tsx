    ...
    return (
        <section className={styles.wrapper}>
            ...
            <div className={styles.container}>
                <Image src={props.image_mid} alt='Конвертор з батареєю середній'/>
                <Image src={props.image_big} alt='Конвертор з батареєю великий'/>
                <Image src={props.image_small} alt='Конвертор з батареєю маленький'/>
            </div>
        </section>
    )
}
